...
set the number of points in the arc part of the arc seperator. Must be a non-negative integer.
...
Possible modes are t and a. t Draws an triangle and a draws and arc. Possible directions are < and > for left and right.

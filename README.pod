...
set the number of points in the curved part of the arc, hemisphere and sigmoid seperator. Must be a non-negative integer.
...
Sets the width parameter used for seperators. The special value - sets the width parameter to the bar height.

=item B<H>

Sets the height parameter used for seperators. The special value - sets the height parameter to the bar height.
